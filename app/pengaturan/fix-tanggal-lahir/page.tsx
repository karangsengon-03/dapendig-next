                    ...
                    <table className="w-full text-xs">
                      <thead className="sticky top-0 bg-[#0d1424] z-10">
                        <tr className="border-b border-white/[0.06]">
                          ...
                          <th className="px-3 py-2 text-left text-xs font-semibold text-rose-500 uppercase tracking-wider">Tersimpan (salah)</th>
                          <th className="px-3 py-2 text-left text-xs font-semibold text-emerald-500 uppercase tracking-wider">Dari NIK (benar)</th>
                          <th className="px-3 py-2 text-left text-xs font-semibold text-slate-500 uppercase tracking-wider">Selisih</th>
                          ...
                          return (
                            <tr key={item.nik} className="border-b border-white/[0.04] last:border-0 hover:bg-white/[0.02]">
                              ...
                              <td className="px-3 py-2">
                                <span className={`text-xs font-semibold px-1.5 py-0.5 rounded ${selisih > 0 ? 'bg-sky-500/10 text-sky-400' : 'bg-rose-500/10 text-rose-400'}`}>
                                  {selisih > 0 ? '+' : ''}{selisih}h
                                </span>
                              </td>
                              <td className="px-3 py-2 text-right">
                                {doneItems.has(item.nik)
                                  ...
                                  : <button onClick={() => handleOneItem(item.nik, item.baru)} disabled={loadingItems.has(item.nik)} className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg bg-amber-500/10 border border-amber-500/20 text-amber-400 text-xs font-medium hover:bg-amber-500/20 transition-colors disabled:opacity-40">
                  ...
                  <table className="w-full text-xs">
                    <thead className="sticky top-0 bg-[#0d1424]">
                      <tr className="border-b border-white/[0.06]">
                        ...
                        <th className="px-3 py-2 text-left text-xs font-semibold text-emerald-500 uppercase tracking-wider">Dikoreksi ke</th>
                      </tr>
                    </thead>
                    <tbody>
