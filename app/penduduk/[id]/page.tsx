          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="rounded-2xl border border-white/[0.06] bg-[#0d1424] px-4 py-1">
                <p className="text-[10px] font-semibold uppercase tracking-wider text-sky-400/70 pt-3 pb-1">Identitas</p>
              ...
              {/* Data Diri */}
              <div className="rounded-2xl border border-white/[0.06] bg-[#0d1424] px-4 py-1">
                <p className="text-[10px] font-semibold uppercase tracking-wider text-sky-400/70 pt-3 pb-1">Data Diri</p>
              ...
              <div className="rounded-2xl border border-white/[0.06] bg-[#0d1424] px-4 py-1 md:col-span-2">
                <p className="text-[10px] font-semibold uppercase tracking-wider text-sky-400/70 pt-3 pb-1">Domisili</p>
            ...
            {(canEdit || canDelete) && (
              <div className="rounded-2xl border border-white/[0.06] bg-[#0d1424] p-4">
                <p className="text-[10px] font-semibold uppercase tracking-wider text-slate-500 mb-3">Aksi</p>
                <div className="flex flex-col gap-2">
                  {/* Baris 1: Edit & Hapus */}
